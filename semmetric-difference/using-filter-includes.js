...
// These do NOT appear in both: 4,Hello,7,9,12,17,19
...
let arrayOne = [1,2,1,2,3,4,"Hello","Hi",7,8,9]; // making a variable named a1 and setting it equal to an array.
let arrayTwo = [1,2,3,"Hi",12,17,19,8]; // making a variable named b1 and setting it equal to an array.

const symmetricDifference = arrayDiff(arrayOne, arrayTwo); // making a variable named symmetricDifference and setting it equal to the function we've built:  ArrayDiff.  We then give the parameters of a & b REAL values (called arguments) and the function plugs those values in to the inner code and spits out (RETURNS) a final value.  In this case it is a single array with the symmetric difference between the two arrays.
console.log('These do NOT appear in both: ' + symmetricDifference);
