...
function reverseAString(string){ //We are creating a function and naming it reverseAString.  reverseAString has one paramter and we are naming it string
  ...
  for (let i = string.length - 1; i >= 0; i--){ //looping through and setting each index, to a variable named i.  we are starting at the end of the length of the string, minus 1 index because of the double-quote, and moving backwards through the length of the parameter string.        
